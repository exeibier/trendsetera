    ...
    <section class="home">
        <div class="row">
            ...
            <div class="col-lg-5 reveal-left">
                <div class="image">
                    <img src="{{asset('img/img-6.jpg')}}" alt="Trendsétera - MARKETING CONSULTING">
                </div>
            </div>
            <div class="col-lg-3 reveal-left">
                <div class="title"><h1>SERVICES</h1></div>
                <div class="service"><h2>MARKETING CONSULTING</h2></div>
                <div class="info">
                    <h4>
...
<script type="text/javascript">
    ...
    $('.menu-services-marketing').addClass('active');
