                ...
                <div class="team">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="item">
                                <div class="photo-box">
                                    <div class="photo" style="background-image: url({{asset('img/team-1.jpg')}})"></div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="item">
                                <div class="photo-box">
                                    <div class="photo" style="background-image: url({{asset('img/team-2.jpg')}})"></div>
                                </div>
                                <div class="name">GERARDO GUTIÉRREZ</div>
                                <div class="position">PROJECT MANAGER</div>
                                <div class="text">
                        ...
                        <div class="col-lg-6">
                            <div class="item">
                                <div class="photo-box">
                                    <div class="photo" style="background-image: url({{asset('img/team-3.jpg')}})"></div>
                                </div>                                <div class="name">GERARDO GUTIÉRREZ</div>
                                <div class="position">PROJECT MANAGER</div>
                                <div class="text">
                                    <p>
                                        porum expliqu odicae quodicias as experorae eos qui aut audaes
                        ...
                        <div class="col-lg-6">
                            <div class="item">
                                <div class="photo-box">
                                    <div class="photo" style="background-image: url({{asset('img/team-4.jpg')}})"></div>
                                </div>                                <div class="name">GERARDO GUTIÉRREZ</div>
                                <div class="position">PROJECT MANAGER</div>
                                <div class="text">
                                    <p>
